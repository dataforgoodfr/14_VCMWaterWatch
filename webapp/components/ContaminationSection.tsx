	...
	return (
		<div className='py-6'>
			...
			<div className='flex flex-col items-center gap-12 md:flex-row md:items-start md:justify-between'>
				<CardImage
					img={{ url: '/images/miami-florida.jpg', alt: 'Miami, Florida (USA).' }}
				...
				/>
				<CardImage
					img={{ url: '/images/normandie-france.jpg', alt: 'France.' }}
				...
				/>
				<CardImage
					img={{ url: '/images/united-kingdom.jpg', alt: 'United Kingdom, Italy, Germany, Sweden, Denmark' }}
