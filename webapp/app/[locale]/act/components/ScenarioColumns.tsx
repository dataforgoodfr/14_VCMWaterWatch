const scenarios = [
	...
	},
	{
		value: 'yellow-orange',
		badge: '🟡🟠',
		title: 'May be at risk of contamination',
		content: (
			<div className='text-navy-800 space-y-3 text-sm'>
				...
				<ul className='list-disc space-y-2 pl-5'>
					<li>
						<strong>Contact your water provider</strong> — Request detailed analysis results for your zone and inquire
						about any planned monitoring or testing measures.
					</li>
					<li>
						<strong>Contact your mayor</strong> — In some cases, the municipality is responsible for water distribution.
						Write to request transparency and action.
					</li>
					<li>
	...
	},
	{
		...
		content: (
			<div className='text-navy-800 space-y-3 text-sm'>
				...
				<ul className='list-disc space-y-2 pl-5'>
					<li>
						<strong>Contact your water provider without delay</strong> — Request a detailed explanation of the situation
						and a clear timeline for corrective actions.
						<ul className='text-navy-600 mt-1 list-disc space-y-1 pl-5'>
							<li>Ask for the latest available water quality data.</li>
							<li>
								Request the implementation of appropriate remediation measures, such as pipe flushing or replacement.
							</li>
							<li>
								If the most recent contamination findings are over a year old, ask whether corrective measures have been
								implemented and whether recent follow-up analyses confirm that the situation is now under control.
							</li>
						</ul>
					</li>
					<li>
						<strong>Contact your mayor</strong> — Use the official letter template to formally request transparency and
						prompt action from local authorities.
					</li>
					<li>
						<strong>Contact your Member of Parliament</strong> — Escalate the issue to ensure it receives national-level
						attention.
					</li>
					<li>
						<strong>Take precautionary measures</strong> — Until the situation is clarified, use bottled water for
						drinking.
					</li>
				</ul>
			</div>
	...
	return (
		<div className='grid grid-cols-1 gap-6 lg:grid-cols-3 lg:items-stretch'>
			{scenarios.map(scenario => (
				<div key={scenario.value} className='flex h-full flex-row gap-2 rounded-lg border border-gray-200 bg-white p-4'>
